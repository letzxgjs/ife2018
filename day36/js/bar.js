...
function createBarChart(foo,data) {
	...
	// 绘制横轴、纵轴
	var axisX = makeSVG('line', {x1:"10", y1:"280",x2:"520",y2:"280",stroke:'blue',strokeWidth:"1"})
	foo.appendChild(axisX)
	var axisY = makeSVG('line', {x1:"10", y1:"10",x2:"10",y2:"280",stroke:'blue',strokeWidth:"1"})
	foo.appendChild(axisY)
	for (var i = 0, len = data.length; i < len; i++) {
		var atts = {}
		atts.x = 25 + i * (barWidth + barGap)
		atts.y = 280 - data[i] * barHeigthRatio
		atts.width = barWidth
